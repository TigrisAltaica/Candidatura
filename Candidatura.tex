...
\begin{figure}
\includegraphics[scale=.75]{OptomechanicalCooling.png}
\caption{Campo electromagnético dentro de una cavidad donde uno de los espejos se encuentra acoplado a un resorte. \cite{BarberisLC}}
\end{figure}
